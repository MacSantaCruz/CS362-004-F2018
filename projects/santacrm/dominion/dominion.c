...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case great_hall:
      greatHallCard(state, handPos, currentPlayer);
      return 0;
...
void smithyCard(struct gameState *state, int handPos, int currentPlayer){
//+3 Cards
  for (i = 1; i < 3; i++)
	{
	  drawCard(currentPlayer, state);
...
void greatHallCard(struct gameState *state, int handPos, int currentPlayer){
  //+1 Card
  drawCard(currentPlayer, state);
	drawCard(currentPlayer, state);		
  //+1 Actions
...
void stewardCard(struct gameState *state, int handPos, int currentPlayer,int choice1, int choice2, int choice3){
